...
--
-- Host: localhost:3306
-- Generation Time: Jul 20, 2018 at 11:51 PM
...
--
-- Database: `jean_jia_test`
--
CREATE DATABASE IF NOT EXISTS `jean_jia_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `jean_jia_test`;
